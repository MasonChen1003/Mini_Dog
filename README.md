...
2. 打開 upload tool (https://github.com/MasonChen1003/Mini_Dog/blob/main/MiniDog_upload_tool/LinkIt7697_upload_tool.exe), 
選擇 com port 及要上傳的 bin file : Mini_Dog_7697_V7RC_V101.ino.bin
![image](tool.png)
